...
public class Run {
    ...
    protected static final String FILE_PATH_2 = "src/main/java/AlarmClock.java";
    protected static final String FILE_PATH_3 = "src/main/java/RollingFileAppender.java";
    protected static final String FILE_PATH_4 = "src/main/java/DiningPhilosophers.java";
